...
class PHPExcel_CachedObjectStorageFactory
{
    ...
    public static function getCacheStorageMethods()
    {
        ...
        foreach(self::$_storageMethods as $storageMethod) {
            $cacheStorageClass = 'Excel\PHPExcel\CachedObjectStorage\PHPExcel_CachedObjectStorage_' . $storageMethod;
    ...
    public static function initialize($method = self::cache_in_memory, $arguments = array())
    {
        ...
        $cacheStorageClass = "Excel\PHPExcel\CachedObjectStorage\PHPExcel_CachedObjectStorage_".$method;
        ...
        if (self::$_cacheStorageMethod === NULL) {
            self::$_cacheStorageClass = 'Excel\PHPExcel\CachedObjectStorage\PHPExcel_CachedObjectStorage_' . $method;
