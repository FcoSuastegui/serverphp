...
use Excel\PHPExcel;
use Excel\PHPExcel\CalcEngine\PHPExcel_CalcEngine_CyclicReferenceStack;
use Excel\PHPExcel\CalcEngine\PHPExcel_CalcEngine_Logger;
use Excel\PHPExcel\Calculation\PHPExcel_Calculation_Function;
use Excel\PHPExcel\Calculation\PHPExcel_Calculation_Functions;
use Excel\PHPExcel\Calculation\PHPExcel_Calculation_Exception;
use Excel\PHPExcel\Calculation\Token\PHPExcel_Calculation_Token_Stack;
/**
 * PHPExcel
 *
...
class PHPExcel_Calculation {
	...
	public static function _wrapResult($value) {
		...
		//	Convert numeric errors to NaN error
			...
			return PHPExcel_Calculation_FunctionsFunctions::NaN();
		}
