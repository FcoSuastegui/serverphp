<?php namespace Excel\PHPExcel\Reader;

use Excel\PHPExcel;
use Excel\PHPExcel\PHPExcel_Cell;
use Excel\PHPExcel\PHPExcel_ReferenceHelper;
use Excel\PHPExcel\PHPExcel_RichText;
use Excel\PHPExcel\PHPExcel_Style;
use Excel\PHPExcel\Reader\Excel2007\PHPExcel_Reader_Excel2007_Theme;
use Excel\PHPExcel\Shared\PHPExcel_Shared_Date;
use Excel\PHPExcel\Shared\PHPExcel_Shared_File;
use Excel\PHPExcel\Shared\PHPExcel_Shared_String;
use Excel\PHPExcel\Style\PHPExcel_Style_Borders;
use Excel\PHPExcel\Style\PHPExcel_Style_Color;
use Excel\PHPExcel\Style\PHPExcel_Style_Font;
use Excel\PHPExcel\Style\PHPExcel_Style_NumberFormat;
use Excel\PHPExcel\Style\PHPExcel_Style_Protection;
...
class PHPExcel_Reader_Excel2007 extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
	...
	public function canRead($pFilename)
	{
		...
		if (!file_exists($pFilename)) {
			throw new PHPExcel_Reader_Exception("No se pudo abrir " . $pFilename . " para leerlo! El archivo no existe.");
		}

		// Check if zip class exists
		if (!class_exists('ZipArchive',FALSE)) {
			throw new PHPExcel_Reader_Exception("La librería ZipArchive no está activa");
		}
