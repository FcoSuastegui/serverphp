<?php namespace Excel\PHPExcel\Writer;

use Excel\PHPExcel;
use Excel\PHPExcel\Calculation\PHPExcel_Calculation_Functions;
use Excel\PHPExcel\PHPExcel_Calculation;
use Excel\PHPExcel\PHPExcel_HashTable;
use Excel\PHPExcel\PHPExcel_Settings;
...
class PHPExcel_Writer_Excel2007 extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
    ...
    public function __construct(PHPExcel $pPHPExcel = null)
    {
		...
		foreach ($writerPartsArray as $writer => $class) {
			$classname = 'Excel\PHPExcel\Writer\Excel2007\\'.$class;
			$this->_writerParts[$writer] = new $classname($this);
		}
