...
use tcpdf\includes\TCPDF_FONT_DATA;
// TCPDF static font methods and data
use tcpdf\includes\TCPDF_FONTS;
// TCPDF static color methods and data
use tcpdf\includes\TCPDF_COLORS;
// TCPDF static image methods and data
use tcpdf\includes\TCPDF_IMAGES;
// TCPDF static methods and data
use tcpdf\includes\TCPDF_STATIC;
...
class TCPDF {
	...
	public function Image($file, $x='', $y='', $w=0, $h=0, $type='', $link='', $align='', $resize=false, $dpi=300, $palign='', $ismask=false, $imgmask=false, $border=0, $fitbox=false, $hidden=false, $fitonpage=false, $alt=false, $altimgs=array()) {
		...
		if ($newimage) {
			...
			if ((method_exists('tcpdf\includes\TCPDF_IMAGES', $mtd)) AND (!($resize AND (function_exists($gdfunction) OR extension_loaded('imagick'))))) {
